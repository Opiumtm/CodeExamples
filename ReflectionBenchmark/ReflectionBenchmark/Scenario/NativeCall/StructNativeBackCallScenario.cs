...
{
    /// <summary>
    /// WinRT/COM back struct call scenario.
    /// </summary>
    public sealed class StructNativeBackCallScenario : IScenario
    {
        public string ScenarioName => "WinRT/COM back CCW struct call";
        ...
        private BenchmarkResult RunBenchmark()
        {
            ...
            INativeCallable callable = new CallableStruct();
