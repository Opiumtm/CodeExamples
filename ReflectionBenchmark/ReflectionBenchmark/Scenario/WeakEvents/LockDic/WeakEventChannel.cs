...
namespace ReflectionBenchmark.WeakEvents.LockDic
{
    /// <summary>
    /// Weak event channel.
    /// </summary>
    public sealed class WeakEventChannel : IWeakEventChannel
    {
        ...
        private static List<WeakReference<WeakEventChannel>> Channels;
        ...
        public static ThreadPoolTimer StartCleanupTask()
        {
            return ThreadPoolTimer.CreatePeriodicTimer(CleanupHandler, TimeSpan.FromMinutes(2));
        }
